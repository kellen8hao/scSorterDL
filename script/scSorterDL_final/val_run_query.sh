...
random_seed=$2
optimizer=${3:-'NAdam'}
drspec=${4:-'/scratch/kbai/results/web_ensembleLDA/cross_validation/dataset1/1/nonof'} #results directory
datadir=${5:-"/project/rrg-ubcxzh/kbai/singlecell_data/cross_validation/dataset1/wilcox_res/screening/1"} #data folder, where train and test are located
ldareg=${6:-0.1}
epochs=${7:-0}
...
dtname="$(basename $(dirname $(dirname $(dirname $datadir))))_$(basename $datadir)"
